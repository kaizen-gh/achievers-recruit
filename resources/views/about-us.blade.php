...
.bg-img-about {
    background: url(../imgs/page/about-banner.jpg) no-repeat top center;
    height:200px;
}
    </style>
  </head>
          ...
          <div class="header-nav">
            <nav class="nav-main-menu">
              <ul class="main-menu">
                ...
                <li ><a class="active" href="{{route('about-us')}}">About Us</a></li>
      ...
      <section class="section-box mt-50">
        <div class="post-loop-grid">
          <div class="container">
            ...
            <div class="row mt-70">
              <div class="col-lg-5 col-md-12 col-sm-12"><img src="{{asset('imgs/page/about/img-about.jpeg')}}" alt="{{env('app_name')}}"></div>
