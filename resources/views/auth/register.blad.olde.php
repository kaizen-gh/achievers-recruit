          ...
          <div class="row login-register-cover">
            <div class="col-lg-6 col-md-6 col-sm-12 mx-auto">
              <div class="text-center">
                ...
                <h2 class="mt-10 mb-5 text-brand-1">Sign Up for free Today</h2>
              ...
              <form class="login-register text-start mt-20" action="{{route('register')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-6 col-lg-6 ">
                    <label class="form-label" for="othernames">User role *</label>
                ...
                <div class="row">
                  <div class="form-group col-md-6 col-lg-6 float-left">
                  ...
                  <div class="form-group col-md-6 col-lg-6 float-right">
                    ...
                    <input class="form-control" id="passwordConfirmation" type="password" required="" name="password_confirmation" placeholder="************">
                  </div>
                </div>
